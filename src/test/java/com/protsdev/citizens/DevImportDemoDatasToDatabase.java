 ...
 */
@SpringBootTest
public class DevImportDemoDatasToDatabase {
    ...
    void import_persist_test() {
        ...
        citizens.forEach(ci -> {
            ...
            ci.getMarriages().forEach(ma -> {
                ...
                System.out.println("marriage date:" + ma.getDateRights().getStartDate());
            });

            ci.getParenthoods().forEach(pa -> {
                System.out.println("parenthood id:" + pa.getId());
                System.out.println("parenthood date:" + pa.getDateRights().getStartDate());
            });
        });
    }
